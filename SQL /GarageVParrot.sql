...
CREATE TABLE users(id INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, last_name VARCHAR(100) NOT NULL, first_name VARCHAR(100) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON(50) NOT NULL);

CREATE TABLE car(id INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, car_name VARCHAR(255) NOT NULL, price DOUBLE NOT NULL, year DATE NOT NULL, kilometers INTEGER NOT NULL, manufacturer VARCHAR(255) NOT NULL, characteristic LONGTEXT NOT NULL);

CREATE TABLE review(id INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, review_name VARCHAR(255) NOT NULL, rating INTEGER NOT NULL, content LONGTEXT NOT NULL);
...
CREATE TABLE contact(id INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, last_name VARCHAR(100) NOT NULL, first_name VARCHAR(100) NOT NULL, phone_number VARCHAR(15) NOT NULL, email VARCHAR(255) NOT NULL, subject VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL);
